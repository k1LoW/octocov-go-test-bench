...
- chore(deps): bump actions/checkout from 6 to 7 in the dependencies group by @dependabot[bot] in https://github.com/k1LoW/octocov-go-test-bench/pull/88
- chore(deps): bump golang.org/x/tools from 0.45.0 to 0.47.0 in the dependencies group by @dependabot[bot] in https://github.com/k1LoW/octocov-go-test-bench/pull/87
...
## [v1.7.8](https://github.com/k1LoW/octocov-go-test-bench/compare/v1.7.7...v1.7.8) - 2026-05-12
### Other Changes
- chore(deps): bump github.com/go-git/go-git/v5 from 5.17.1 to 5.18.0 by @dependabot[bot] in https://github.com/k1LoW/octocov-go-test-bench/pull/79
- chore(deps): bump the dependencies group with 3 updates by @dependabot[bot] in https://github.com/k1LoW/octocov-go-test-bench/pull/78
- chore(deps): bump github.com/go-git/go-git/v5 from 5.18.0 to 5.19.0 by @dependabot[bot] in https://github.com/k1LoW/octocov-go-test-bench/pull/82
